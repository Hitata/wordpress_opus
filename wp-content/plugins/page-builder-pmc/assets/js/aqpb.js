	...
	$( "ul.blocks, ul.prebuild" ).bind( "sortstop", function(event, ui) {
		...
		if (ui.item.hasClass('ui-draggable')) {
			...
			$(document).ready(function () {
				...
				jQuery(document).on("click", '#'+content+' .shortcode-buttons' , function(){
					var id_number = content.split("-");
					var shortcode = jQuery(this).attr('id');
					returnShortcodeValue(shortcode,block_id);
