    ...
    <div id="shortcodes">
		...
		<div id="select-shortcode-<?php echo $rand ?>"class="select-shortcode">
			...
			<div id="remove" class="builderremove-<?php echo $rand ?>" data-option-key="filter">
				...
				<!-- toggle elements -->
				<a class="shortcode-buttons text premium-shortcode image resp_lightbox" data-category="text premium-shortcode" id="lightbox" title="Lightbox Image"><i class="fa fa-picture-o"></i>Lightbox Image</a>
				...
				<a class="shortcode-buttons premium-shortcode" data-category="premium-shortcode"  id="pricing_tables" title="Pricing table"><i class="fa fa-table"></i>Pricing table</a>
				<a class="shortcode-buttons premium-shortcode" data-category="premium-shortcode"  id="pricing_tables_icon" title="Pricing table"><i class="fa fa-table"></i>Icon pric. table</a>
				<a class="shortcode-buttons premium-shortcode" data-category="premium-shortcode"  id="pricing_tables_circle" title="Pricing table with circle"><i class="fa fa-table"></i>Circle pric. table</a>
				<a class="shortcode-buttons premium-shortcode" data-category="premium-shortcode"  id="pricing_tables_white" title="White pricing table"><i class="fa fa-table"></i>White pric. table</a>
				...
				<a class="shortcode-buttons premium-shortcode" data-category="premium-shortcode"  id="count_block_simple" title="Count block Simple"><i class="fa fa-table"></i>Simple count b.</a>	
				...
				<a class="shortcode-buttons premium-shortcode" data-category="premium-shortcode"  id="scroll_link" title="Scroll link"><i class="fa fa-link"></i>Scroll link</a>					
			</div>
