...
<div class="wrap">
	...
	<div id="page-builder-frame">
		...
		<div id="page-builder-column" class="metabox-holder <?php echo $disabled ?>">
			<div id="page-builder-archive" class="postbox">
				<h3 class="hndle"><span><?php _e('Available Blocks', 'framework') ?></span><span id="removing-block"><?php _e('Deleting', 'framework') ?></span></h3>				<p>* Drag & Drop the blocks to the page builder below to start building. Or select the categories first.</p>
				<div class="inside">
								...
								<div id="submitpost" class="submitbox">
									<div class="major-publishing-actions cf">
										...
										<div class="publishing-action">
											...
											<?php submit_button( empty( $selected_template_id ) ? __( 'Create Template', 'framework' ) : 'Save Template', 'button-primary ', 'save_template', false, array( 'id' => 'save_template_header' ) ); ?>
										...
										?>" title="'. __('Add Template', 'framework') .'">											
										...
										<div class="delete-action">
											...
											echo '<a class="submitdelete deletion template-delete" href="' . esc_url(add_query_arg(
												...
												admin_url( 'themes.php' )
											)) . '" title="'. __('Delete Template', 'framework') .'"><i class="fa fa-times"></i></a>';
											?>
										</div><!-- END .delete-action -->								
										<div class="delete-action">
											<?php 
											echo '<a class="template-duplicate" title="'. __('Duplicate Template', 'framework') .'"><i class="fa fa-files-o"></i></a>';
											?>
										</div><!-- END .delete-action -->											
	...
	<div class="show-column">		
		...
		<div class="save-button">			
			...
			<?php submit_button( empty( $selected_template_id ) ? __( 'Create Template', 'framework' ) : 'Save Template', 'button-primary ', 'save_template', false, array( 'id' => 'save_template_fixed' ) ); ?>	
