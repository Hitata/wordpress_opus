<?php
class PMC_Prebuild_Footer extends AQ_Block {
	private $title;
	...
	function __construct() {
		$block_options = array(
			...
			'icon_color' => 'FFF',
			'category' => 'Prebuild',
			'help' => 'This is prebuild footer block with four widgets.',
			'class' => 'block-aq_column_block prebuild-column-wrapper'
		);
		
		//create the block
		parent::__construct('pmc_prebuild_footer', $block_options);		
	...
	function form($instance) {
		...
		<p class="empty-column prebuild-column-title">
			<?php echo __('Drag widgets into this column box', 'pmc-themes') ; ?>
		</p>
	...
	function form_callback($instance = array()) {
		...
		extract($instance); ?>
			...
			<dl class="block-bar">
				<dt class="block-handle">
					<div class="block-title">
						<i class="fa fa-female " style="color:FFF"></i>Prebuild Footer Block
					</div>
			...
			<p class="empty-column prebuild-column-title">
				<?php echo __('Drag widgets into this column box', 'framework'); ?>
			</p>
